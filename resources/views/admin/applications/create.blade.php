...
<div class="container-fluid p-0">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h4 class="mb-1 fw-bold text-dark">Create Application</h4>
            ...
            <form action="{{ route('admin.applications.store') }}" method="POST">
                ...
                <div class="row mb-3">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="name" class="form-control rounded-pill px-3" required 
                            value="{{ old('name') }}" placeholder="e.g. SEO Booster">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="slug" class="form-control rounded-pill px-3" required 
                            value="{{ old('slug') }}" placeholder="e.g. seo-booster">
                ...
                <div class="mb-4">
                    ...
                    <textarea name="description" class="form-control rounded-4 p-3" rows="4" 
                        placeholder="Brief application description">{{ old('description') }}</textarea>
                ...
                <div class="text-end">
                    ...
                    <button type="submit" class="btn btn-primary rounded-pill px-5 shadow-sm">Save Application</button>
                </div>
            </form>
        </div>
    </div>
