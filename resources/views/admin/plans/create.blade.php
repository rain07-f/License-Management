...
@section('content')
    <div class="row mb-4">
        <div class="col-md-6">
            <h5 class="fw-bold mb-0">Create New Plan</h5>
        </div>
                    ...
                    <form action="{{ route('admin.plans.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="name" class="form-control @error('name') is-invalid @enderror"
                                placeholder="e.g. Professional Plan" value="{{ old('name') }}" required>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="description" class="form-control @error('description') is-invalid @enderror"
                                rows="3" placeholder="Brief details about the plan..."
                        ...
                        <div class="row mb-4">
                            <div class="col-md-4">
                                ...
                                <input type="number" step="0.01" name="price"
                                    class="form-control @error('price') is-invalid @enderror" placeholder="99.00"
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="number" name="duration_days"
                                    class="form-control @error('duration_days') is-invalid @enderror" placeholder="365"
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="number" name="domain_limit"
                                    class="form-control @error('domain_limit') is-invalid @enderror" placeholder="1"
                                    value="{{ old('domain_limit') }}" required>
